...
- `SHELF.md`
- `SHELF.config`
- Any `.mod` modules listed in **Modules** (all caps filenames).
...
## Workflow branches
* Brainstorm Session workflow — see `.harbormaster/branches/brainstorm-session.branch`.
* Branch feature conventions — see `.harbormaster/branches/branch-features.branch`.
* Running issues workflow — see `.harbormaster/branches/running-issues.branch`.
